...
namespace ArizonaSunshineLIV
{
	public class ArizonaSunshineLIVMod : MelonMod
	{
		...
		private void SetUpLiv(Camera camera)
		{
			...
			liv.fixPostEffectsAlpha = false; //AZ
			liv.spectatorLayerMask = -537395459; //Arizona Sunshine, sky issue, holder ring, rotation black out, hands 

            //SetUpPlayerVisibility(liv, false);
